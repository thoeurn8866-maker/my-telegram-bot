...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat_type in ['group', 'supergroup']:
        ...
        await update.message.reply_text(
            f"ជម្រាបសួរ {user_first_name}!ការិយាល័យបុគ្គលិក សូមធ្វើបច្ចុប្បន្នភាពបញ្ជីឈ្មោះនៃចំនួន សហព័ន្ធ(ប្តី-ប្រពន្ធ ពុំមានមុខរបរ) និងកូនក្នុងបន្ទុក ដែលមានអាយុពី ១៥ឆ្នាំ ដល់២៥ឆ្នាំ(ជាសិស្ស-និស្សិត)  របស់ថ្នាក់ដឺកនាំ-និយោជិត ទ.ក. ទាំងអស់ គិតមកដល់ថ្ងៃ២៤-០៧-២០២៦ សម្រាប់យកមកធ្វើការគណនាបន្ថយមូលដ្ឋានកំណត់ពន្ធ 
            ចំណាយលើប្រាក់ពន្ធបៀវត្សត្រូវបង់ប្រចាំខែឆ្នាំរបស់ថ្នាក់ដឺកនាំ-និយោជិត ទ.ក. ទាំងអស់ ជូនអគ្គនាយកដ្ឋានពន្ធដារ និងរក្សាទុកយោងសម្រាប់ការបំភ្លឺផ្តល់ជូនភាគីពាក់ព័ន្ធ នៅពេលរងការធ្វើសវនកម្ម​ក្នុងការិយបរិច្ឆេទឆ្នាំនីមួយៗ។
            --------------------------------------------------------------------------------
            ដើម្បីរក្សាការសម្ងាត់ព័ត៌មាន សូមចុចប៊ូតុងខាងក្រោមដើម្បីបំពេញព័ត៌មាននៅក្នុង Chat ផ្ទាល់ជាមួយ Bot ៖",
